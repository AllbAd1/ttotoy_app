...
/// Flutter의 ThemeExtension, Widget, State, TextStyle 등은 모두 불변 객체(Immutable Object) 로 설계되어 있으며, 그 이유로
...
@immutable
class VariableColors extends ThemeExtension<VariableColors> { /// ThemeExtension 상속
  ...
  /// 배경색상은 라이트/다크 테마 다르게 설정해야하므로 따로 선언.

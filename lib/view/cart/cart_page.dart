        ...
        children: [
          ...
          Expanded(
            child: GestureDetector(
              onTap: onTap, // 상세 페이지 이동
              behavior: HitTestBehavior.opaque, // 빈 공간도 탭 되도록
              child: Row(
                children: [
                  ClipRRect(
                    borderRadius: BorderRadius.circular(12), // 이미지 모서리 둥글게
                    child: _CartProductImage(  // 커스텀 이미지 위젯
                      imageUrl: cartItem.product.imageAssets.isNotEmpty
                          ? cartItem.product.imageAssets.first
                          : '', // 이미지가 없는 경우 에러 위젯 표시
                      width: 70,
                      height: 70,
                    ),
...
// ★★★ _CartProductImage 위젯 (기존과 동일, BoxFit.contain 적용됨) ★★★
